...
{\footnotesize \textsuperscript{*} Sistemas Embarcados: Doc. Rodrigo Freire Bastos - rodrigo.bastos@aln.senaicimatec.edu.br}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.5\textwidth]{Screenshot from 2022-05-19 16-27-17.png}}
...
\begin{figure}[h]
\centerline{
    \includegraphics[width=0.5\textwidth]{esquematico.png}
    }
\caption{Example of a figure caption.}
\label{fig}
\end{figure}
